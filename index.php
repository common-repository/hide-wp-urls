<?php
/*
  Copyright (c) 2016 - 2019, WPPlugins.
  The copyrights to the software code in this file are licensed under the (revised) BSD open source license.

  Plugin Name: Hide WP URLs
  Plugin URI:
  Description: You can choose to hide the admin URLs and login to increases your wordpress security against hackers and spammers. <br /> <a href="https://wpplugins.tips/wordpress" target="_blank"><strong>Unlock all features</strong></a>
  Version: 3.0.01
  Author: WPPlugins - WordPress Security Plugins
  Author URI: https://wpplugins.tips
 */
if (!defined('HMW_VERSION')) {
    define('HMW_VERSION', '3.0.01');
    /* Call config files */
