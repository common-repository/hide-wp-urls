...
class HMW_Controllers_Settings extends HMW_Classes_FrontController {
    ...
    public function init() {
        ...
        if (HMW_Classes_Tools::getOption('hmw_mode') == 'lite') {
            HMW_Classes_Error::setError(sprintf(__('We\'ve created a 72 hours coupon for you to %sunlock Hide My WP Ghost premium features%s with %sonly $23.99%s. Use this coupon: %s1HIDEMYWP20%s. %sSee the prices%s', _HMW_PLUGIN_NAME_), '<strong style="color: red">', '</strong>', '<strong style="color: red">', '</strong>', '<strong  style="color: red">', '</strong>', '<a href="https://hidemywp.co/wordpress_update" target="_blank" style="font-weight: bold">', '</a>'));
        }
    ...
    public function action() {
        ...
        switch (HMW_Classes_Tools::getValue('action')) {
            ...
            case 'hmw_support':
                ...
                $subject = __('Hide Wp URLs > Question', _HMW_PLUGIN_NAME_);
