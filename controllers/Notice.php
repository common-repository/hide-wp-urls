    ...
    public function hmw_admin_notices($notices) {
        ...
        if (is_string($disable) && $disable <> '') {
            $notices['two_week_review'] = array(
                ...
                'msg' => sprintf(__("Want to use all %sHide My WP Ghost features%s? Get %s5 Websites License%s today with %sonly $52.50%s (65%% discount)", _HMW_PLUGIN_NAME_), '<strong style="color: red">', '</strong>', '<strong style="color: red">', '</strong>', '<strong  style="color: red">', '</strong>'),
                'link' => '<li><span class="dashicons dashicons-external"></span><a href="https://secure.2checkout.com/order/checkout.php?PRODS=9396523&QTY=1&CART=1&CARD=2&DESIGN_TYPE=2&SHORT_FORM=1&CURRENCY=USD&LANG=en&LANGUAGES=en&COUPON=5HIDEMYWP65&SRC=plugin" target="_blank" style="font-weight: bold">' . __("Go To Offer", _HMW_PLUGIN_NAME_) . '</a></li>
